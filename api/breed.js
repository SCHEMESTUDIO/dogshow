...
<p>The recurring pattern in Great Dane fame is consistent: they arrive, they are enormous, and they behave better than most dogs half their size. That combination — the gap between what the size suggests and what the dog actually does — is what makes the breed memorable.</p>`,
  ...
  'great-pyrenees': {
    name: 'Great Pyrenees',
    headKeyword: 'Great Pyrenees',
    metaDescription: "The Great Pyrenees: a mountain guardian bred for a thousand years to protect livestock alone, with an independence and a dignity that comes with the job. A field guide, with stage notes.",
    facts: {
      'Group': 'Working',
      'Size': 'Males typically exceed 100 lb · Females ~85 lb · 25–32 inches at shoulder',
      'Temperament': 'Confident, gentle, affectionate, patient, protective, independent, calm',
      'Life expectancy': '10–12 years',
      'Coat': 'Long, flat, thick double coat; straight or slightly undulating with dense woolly undercoat',
      'Colors': 'White or predominantly white; markings (badger, gray, tan, reddish-brown) limited to ~1/3 of body, usually on ears, head, or tail',
      'AKC recognized': 'Yes — 1933, Working Group (1934)',
      'Origin': 'Pyrenees Mountains (France/Spain border), developed by Basque shepherds; 1,000+ years guarding livestock against wolves and bears',
    },
    lede: `The Great Pyrenees was built for a job that involves being alone in a mountain pass all winter with nothing but a flock of sheep and the wolf that wants to eat them. That heritage sits in every fiber of the breed: the massive white coat that blends with snow, the self-reliance that comes from making decisions without a human telling it what to do, the protective instinct that does not wait for permission. A Great Pyrenees is not a dog that needs you to tell it the situation is dangerous — it has already assessed the situation, decided what will happen, and is acting on that decision independently. Bred for 1,000 years to guard livestock in the Pyrenees Mountains between France and Spain, the breed still carries that guardian's solitary competence, wrapped in a body that can weigh over 100 pounds and a demeanor of perfect, patient calm.`,
    spotlight: `<p>A Great Pyrenees arriving on stage is architectural. The sheer size — often 100 to 160 pounds of lean muscle under a long, thick white coat — fills the frame with a kind of monumental presence. The double coat, designed to shed water and insulate in alpine cold, catches studio light in waves of cream and white. The face is broad and noble, the eyes intelligent and calm, the bearing that of a dog that has never doubted its own judgment.</p>
<p>What separates the Pyr from other large white dogs is the visible independence. A Labrador looks at the camera with a question — "am I doing this right?" — but a Great Pyrenees looks at the camera as an equal, assessing. This is a dog making its own decision about whether to engage, and making that decision on its terms. When it does settle, there is a profound dignity to it, the stillness of an animal that does not need to perform.</p>
<p>Viewers often describe the feeling as being trusted by something very large that has no need to trust you but is choosing to anyway. The coat is beautiful, but the personality is magnetic — that combination of size and absolute self-possession reads as nobility. Bone counts come in steady and warm rather than explosive; the Great Pyrenees receives them as fitting tribute rather than surprising attention. Regulars describe watching one as meditative — the performance is in the being, not the doing.</p>`,
    ownerFitHeading: 'Is a Great Pyrenees right for you?',
    ownerFit: `<p>The Great Pyrenees is a working dog, not a companion breed that happens to work. That distinction matters enormously before you commit to one.</p>
<p><strong>Independence is not a flaw to train out.</strong> The breed was selected for 1,000 years to make its own decisions about threats, without waiting for a human to tell it what to do. This is the dog's entire purpose. An owner expecting a Great Pyrenees to be as biddable as a Golden Retriever or a Border Collie will be chronically frustrated, because the dog is doing exactly what it was bred for: thinking for itself. Early, broad socialization and consistent, reward-based training work. Harsh corrections do not — they create confusion in a dog that was never built to accept unquestioned obedience. Understand this before you own one.</p>
<p><strong>Space and climate are requirements, not preferences.</strong> Great Pyrenees need room — real acreage, or at minimum a large, securely fenced yard. They are not apartment dogs. The thick double coat means they thrive in cool to temperate climates and genuinely suffer in heat. A Great Pyrenees in Phoenix in July is a welfare issue, not a lifestyle choice. They need a cool space to retreat to when temperatures rise, shade, fresh water always available, and no expectation of outdoor exercise during hot weather.</p>
<p><strong>Exercise — the kind of exercise, matters more than the amount.</strong> Great Pyrenees are not marathon runners. They don't need hours of jogging. What they need is space to move at their own pace, patrol territory, and — if they're truly in their element — do the work they were bred for (livestock guardian, search-and-rescue, or therapy work). A bored Great Pyrenees in too-small a space can become destructive or develop anxiety-driven behaviors like excessive barking or digging.</p>
<p><strong>Shedding is a serious commitment.</strong> The double coat sheds constantly with two major seasonal blowouts where seemingly every undercoat hair decides to leave at once. Brushing two to three times a week keeps the worst under control, but you need to accept that you will have white fur on everything you own. A lint roller becomes a lifestyle. During seasonal blowouts, daily brushing is more realistic.</p>
<p><strong>They were built to bark.</strong> A Great Pyrenees on livestock guardian duty uses its deep, booming voice to communicate with the flock and warn off threats from a distance. This habit does not disappear in a suburban setting. Excessive barking, especially at night, is a breed trait, not a training failure — the breed is doing what it was selected to do. If you live where neighbors will object, this is a serious incompatibility. Know your local noise ordinances before buying.</p>
<p><strong>Health — bloat is the nightmare.</strong> Like other large-breed dogs, Great Pyrenees are at risk for gastric dilatation-volvulus (bloat), where the stomach fills with gas and can twist. It is life-threatening and can be fatal in hours. Approximately 37% of large-breed dogs experience bloat in their lifetime. Learn the warning signs: restlessness, pacing, unsuccessful retching, a distended abdomen. Feed smaller meals multiple times a day rather than one large meal, avoid vigorous exercise immediately before or after eating, and know the route to an emergency vet clinic. Bloat is not common — but when it strikes, every minute counts.</p>
<p><strong>Other health concerns.</strong> Hip and elbow dysplasia, patellar luxation, cataracts, progressive retinal atrophy, and bone cancer (osteosarcoma) show up in the breed. Choose a breeder who has hip-screened and elbow-screened both parents and can show you the paperwork. Do not skip this step. The breed's lifespan is 10 to 12 years — shorter than you might hope, and something to face honestly before committing.</p>
<p><strong>Temper is steady but not bulletproof.</strong> Great Pyrenees are not naturally aggressive, but they are naturally protective. Proper socialization from puppyhood — exposure to many people, places, and experiences — helps channel that protective instinct into discernment rather than blanket suspicion. An under-socialized Great Pyrenees can become overly protective and wary. Early, consistent socialization is not optional; it is foundational.</p>
<p><strong>The honest verdict:</strong> for an owner with space, understanding of the breed's independent nature, acceptance of serious shedding and barking, and genuine readiness for the responsibility, a Great Pyrenees is one of the most noble, loyal, and genuinely pleasant companions a dog can be. For someone expecting a big Golden Retriever or a dog that wants primarily to please, this is the wrong breed. Choose honestly, and a Great Pyrenees will guard your family and your peace with equal conviction for a decade of quiet, dignified partnership.</p>`,
    famousHeading: 'Famous Great Pyrenees',
    famous: `<p>The Great Pyrenees arrived in America surprisingly late — the breed was not widely known in the United States until the twentieth century, though it had guarded livestock and patrolled mountains for a thousand years before that. The first recorded Great Pyrenees to win an American championship was Urdos de Soum (1931–1943), who became the first AKC champion of the breed in 1934 after being shown at AKC shows beginning in 1932. Urdos de Soum sired the first American-bred litter and founded the breed's American legacy.</p>
<p>Royal patronage, historically, has been the breed's calling card — not cinema fame. Queen Marie-Antoinette and Queen Victoria both owned Great Pyrenees; the breed was named the "Royal Dog of France" by King Louis XIV in 1675. The working heritage runs deeper than celebrity — these are dogs remembered not for red-carpet appearances but for centuries of honest work, protecting flocks in weather that would have killed lesser animals, making decisions in the dark that shepherds couldn't have made for them. Modern fame skews toward the working side: the breed is used in search-and-rescue operations, avalanche rescue in alpine environments, and therapy work, where its calm, protective nature translates beautifully to helping people who are struggling.</p>
<p>In recent years, actress Jennifer Aniston adopted a Great Pyrenees-mix rescue and has been spotted walking the dog in Los Angeles, giving the breed a small celebrity moment. But the real Great Pyrenees fame, if it exists at all, comes from working dogs whose names never make headlines — the ones patrolling mountain ranges, protecting livestock, or lying beside a person who needed a quiet, loyal presence in their life. For a breed that spent 1,000 years deciding what matters without human input, that seems entirely fitting.</p>`,
    relatedBreeds: [
      { slug: 'newfoundland', name: 'Newfoundland' },
      { slug: 'bernese-mountain-dog', name: 'Bernese Mountain Dog' },
      { slug: 'german-shepherd', name: 'German Shepherd' },
