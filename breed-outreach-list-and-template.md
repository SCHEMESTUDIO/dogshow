# Breed Outreach — Prospect List + Email Template

**Goal:** build relationships + backlinks for dogshow.lol's `/breeds/{slug}` pages.
**The deal (per James):** invite them to contribute a *quote/tip* for our breed page → we credit them with a **link back to their site** (the carrot, benefits them). Then softly ask if **we can write a piece for their blog** → **link back to dogshow.lol** (the prize, benefits us).
**Compiled:** 2026-06-23. Prospects found via web search + page fetch. Two entries (Lost Creek, Mini Golden Paws) independently re-verified by me; the rest are at the confidence noted.

---

## How to use this (read first — 2 min)

1. **Personalize the `[detail]` line every time.** One sentence referencing their actual site/recent post. Generic blasts get ignored and can ding your sending reputation. Budget ~1 min per email.
2. **Send from a real, monitored address** (`james@wearescheme.studio` or a `@dogshow.lol` address) — never no-reply.
3. **Lead with the carrot.** The quote ask (a link *to them*) is the easy yes. Keep the guest-post ask (a link *to you*) as the secondary line so you're not opening with the bigger lift.
4. **Contact method matters.** Where there's a verified email, you can send the full email. Where it's a **contact form / IG DM**, use the short variant below — those are flagged "manual" in the list.
5. **Keep it editorial — don't pay for links.** A paid link exchange violates Google's guidelines and risks both sites.

### Honest expectations (so you calibrate effort)
- **These are mostly small breeder/owner sites.** Their links are *topically relevant* (good) but *low domain authority* (modest individual weight). The play is **volume of relevant links**, not a few big ones. *(Confidence: Medium-High.)*
- **Some breeders may hesitate to link out** to anything that smells like competition for attention. Frame dogshow.lol as *complementary* — a fun, free place to show off the dogs they've bred/raised, not a rival. *(Medium.)*
- **Expect some `rel="nofollow"` links.** Still worth it: referral traffic + topical relevance. *(High.)*
- **Realistic reply rate on cold outreach like this is ~10–25%** even when personalized. Send to all ~30 to land a handful. *(Medium — depends heavily on personalization.)*

---

## Email template (full — use where a verified email exists)

**Subject:** A quote from [Site name] for our [Breed] page?

> Hi [First name],
>
> I run The Dog Show (dogshow.lol) — a live, online dog show where people enter their dogs and the audience cheers them on. [detail — e.g. "Loved your recent post on smooth vs. curly coats."] We're building out a proper [Breed] page, and I'd much rather feature real [Breed] people than write the whole thing from behind a screen.
>
> Would you be up for contributing a short tip or quote — anything you wish new [Breed] owners knew? I'll credit you by name with a link back to [site] right on the page.
>
> If you're open to it, I'd happily return the favor: I could write an original piece for your blog — your topic, your angle, no cost — fresh content for your readers.
>
> Either one, both, or neither, no pressure. Just figured [Breed] folks ought to stick together.
>
> Warmly,
> James
> The Dog Show · dogshow.lol

## Short variant (for IG DM / contact form — the "manual" prospects)

> Hi [First name] — I run The Dog Show (dogshow.lol), a live online dog show. We're building a [Breed] page and would love a short quote/tip from you, credited with a link back to [site]. Happy to return the favor with an original article for your blog. Worth a chat?

---

## The prospect list

Legend — **Contact:** ✉️ = verified public email (full template OK) · 📝 = contact form · 📱 = phone/DM only (manual). **Conf** = confidence the site is real + active.

### Bernedoodle  *(Vol 49.5K · WS 6.0 — top pick)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Triple C Acres | triplecacres.co | Bernedoodle breeder | Yes (active Dec 2025) | 📝 /contact-triple-c-acres/ · IG @triplecbernedoodles | High |
| 2 | Moose the Mini Bernedoodle | moosebernedoodle.com | IG-first + site/blog | Yes | 📝 /contact-us · IG @moose_bernedoodle | High |
| 3 | Lost Creek Kennels | lckennels.com | Doodle breeder (not Bernedoodle-only) | Yes /dog-blog/ | ✉️ info@lostcreekdoodles.com | High ✔re-verified |
| 4 | Chewy the Bernedoodle | chewybernedoodle.com | Personal owner blog | Yes | 📝 form · IG @chewy_bernedoodle | Med — *dormant since 2022* |
| 5 | Alpine Bernedoodles | alpinebernedoodles.com | Breeder w/ dog-blog | Yes | verify on /contact | Med — *not fetched, confirm first* |

> Note: Lost Creek is a general doodle breeder (Goldendoodle, Labradoodle, Bordoodle) — not Bernedoodle-specific — but active, has a blog, and a real email. Triple C is the cleanest Bernedoodle-only + currently-active target.

### German Shepherd  *(Vol 60.5K · WS 4.0 — highest volume)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Anything German Shepherd | anythinggermanshepherd.com | Breed-info site | Yes (active Jul 2025) | ✉️ info@anythinggermanshepherd.com · **has a "Write For Us" page** | High |
| 2 | German Shepherd 101 | germanshepherd101.com | Breed-info ("Sarah Miller") | Yes (updated 2026) | 📝 /about/ · FB | High |
| 3 | World of Dogz | worldofdogz.com | Multi-breed, strong GSD section (UK) | Yes (active 2025) | 📝 /contact/ | High |
| 4 | German Shepherd Dog HQ | germanshepherddoghq.com | Breed-info | Yes | ❓ contact page empty — verify | Med |
| 5 | Shepherd Sense | shepherdsense.com | GSD personal blog | Yes | 📝 /contact-page/ | Med — *dormant since 2021* |

> Best two: **Anything German Shepherd** (open "Write For Us" + real email — ideal for the guest-post ask) and **German Shepherd 101** (dedicated, recently updated).

### Mini Golden Retriever  *(Vol 40.5K · WS 5.5)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Mini Golden Paws | minigoldenpaws.com | Breeder (Jamie Hafen) | Yes (active Jun 2026) | ✉️ jamie@minigoldenpaws.com | High ✔re-verified |
| 2 | Big Hearted Breeders | bigheartedbreeders.com | Breeder + breeding coach | Yes (updated 2026) | ✉️ info@bigheartedbreeders.com | High |
| 3 | Robyn's Nest Mini Goldens | robynsnestminigoldens.com | Breeder | Yes | 📝 /contact/ (email obfuscated) | High |
| 4 | Pacific NW Mini Goldens | pnwminigoldens.com | Breeder | No | 📝 /contact/ · IG @pnwminigoldens | High site / Med fit |
| 5 | Little Retriever Ranch | littleretrieverranch.com | Breeder (new, 2024) | No | 📝 /contact/ | Low priority |

### Australian Labradoodle  *(Vol 40.5K · WS 5.0)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Heritage Manor Labradoodles | heritagemanorlabradoodles.com | Breeder | Yes (active May 2026) | ✉️ heritagemanorlabradoodles@gmail.com | High |
| 2 | Northbound Aus. Labradoodles (UK) | northboundaustralianlabradoodles.com | Breeder, candid blog | Yes (Jan 2026) | ✉️ northboundlabradoodles@gmail.com | High |
| 3 | Cream Puff Labradoodles | creampufflabradoodles.com | Breeder, magazine-style blog | Yes (Dec 2025) | ✉️ hello@creampufflabradoodles.com | High |
| 4 | Snooze & Sniff | snoozeandsniff.com | Breeder, big named-author blog | Yes (Nov 2025) | 📝 form | High |
| 5 | Royal Australian Labradoodles | royalaustralianlabradoodles.com | Breeder blog | Yes | 📝 /contact-us/ | Med — *blog stale since 2024* |

> Cream Puff already runs playful "Just For Fun" content — closest editorial match for a fun online dog-show feature.

### Labradoodle  *(Vol 18.1K · WS 5.0 — very winnable)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Ashford Manor Labradoodles | ashfordmanorlabradoodles.com | Breeder ("Building Bonds" series) | Yes (Jun 2026) | ✉️ amdoodles@gmail.com | High |
| 2 | Snowy River Labradoodles | snowyriverdoodle.com | Breeder, most prolific blog found | Yes (Jun 2026) | 📝 /contact-us/ | High |
| 3 | Heritage Manor Labradoodles | heritagemanorlabradoodles.com | *(also fits here — generic-Labradoodle posts)* | Yes | ✉️ heritagemanorlabradoodles@gmail.com | High |
| 4 | Loveable Labradoodles | loveablelabradoodles.com | Breeder, light blog | Yes (Feb 2025) | 📝 /contact-form | Med |
| 5 | Royal Australian Labradoodles | royalaustralianlabradoodles.com | *(also has generic Labradoodle posts)* | Yes | 📝 /contact-us/ | Med |

> Heritage Manor & Royal Aus. appear in both doodle lists — pitch each **once**, against whichever breed page is the better fit (don't double-email).

### Saint Berdoodle  *(Vol 14.8K · WS 6.0 — niche, winnable)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Prize Poodles and Doodles | prizepoodlesanddoodles.com | Breeder, active care blog | Yes (2024–26) | ✉️ Tom@PrizePnD.com | High |
| 2 | My Darling Doodles | mydarlingdoodles.com | St. Berdoodle specialist | Info pages | ✉️ mydarlingdoodles@gmail.com | High |
| 3 | Best Saint Berdoodles (Crockett) | saint-berdoodles.com | Breeder network | Info-heavy, no blog here | ✉️ team@crockettdoodles.com | High |
| 4 | Mason Creek Saint Berdoodles | masoncreeksaintberdoodles.com | Breeder | Info page | 📝 /contact-us.html (email obfuscated) | Med-High — *winding down by 2027* |

### Mini Aussie  *(Vol 12.1K · WS 7.0 — highest winnability)*

| # | Site | URL | Type | Blog? | Contact | Conf |
|---|------|-----|------|-------|---------|------|
| 1 | Painted Blue Aussies | paintedblueaussies.com | Breeder, educational blog ("Erika") | Yes | ✉️ PaintedBlueAussies@gmail.com | High |
| 2 | Blue Buckaroo Aussies | buckarooaussies.com | Breeder, very active owner-blog | Yes (Jun 2026) | 📝 /contact-us/ | High |
| 3 | Kicks and Giggles Mini Aussies | kicksandgigglesminiaussies.com | Breeder, personal blog | Yes (Jun 2026) | 📱 (207) 319-5956 · 📝 /contact-us/ | High active / Med value (WP.com) |
| 4 | Run'n Bear Mini Aussies | mini-australian-shepherds.com | Breeder, care/training blog | Yes /blog/ | verify on /contact | Med — *not fetched, confirm first* |

---

## Suggested send order (highest-leverage first)

1. **The "open door" guest-post targets** — sites that already invite or routinely publish outside content: **Anything German Shepherd** (Write For Us), **Lost Creek** (guest submissions), **Cream Puff**, **Snowy River**, **Blue Buckaroo**, **Ashford Manor**.
2. **Verified-email + active blog** (fast path to a reply): Mini Golden Paws, Big Hearted Breeders, Heritage Manor, Northbound, Tom @ Prize P&D, My Darling Doodles, Painted Blue Aussies.
3. **Active but contact-form/DM only** (use short variant, manual): Triple C, Moose, World of Dogz, Robyn's Nest, Snooze & Sniff, Mason Creek, Kicks & Giggles.
4. **Verify-first / possibly dormant** (confirm before spending effort): Alpine, German Shepherd Dog HQ, Shepherd Sense, Chewy, Royal Aus., Loveable, Run'n Bear, PNW, Little Retriever Ranch.

## Provenance & honesty notes
- Every URL was located via search and (for most) fetched. Emails are reported **only where literally seen on the page** — none invented. Where I note "email obfuscated" the site hides it behind a script, so use the form.
- Four entries are flagged **"not fetched / verify first"** — they surfaced credibly in search but weren't directly confirmed. Check those live before sending.
- "Dormant" flags mean the blog hasn't posted recently; the site is still up. You *can* still pitch (angle: "fresh content to revive the blog") but reply odds are lower.

---

## Personalized messages — the 19 form/DM prospects (added 2026-06-23)

Short, form/DM-friendly versions, each with a real personalized detail. Paste into the site's contact form or IG DM. Where I have a likely owner name I've used it; "Hi there" where the name isn't confirmed. The 12 email-draft prospects are NOT repeated here.

### Bernedoodle (4)

**Triple C Acres** — form: triplecacres.co/contact-triple-c-acres/ · IG @triplecbernedoodles
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your Bernedoodle blog full of care tips and litter stories is exactly the real-owner voice I'm after. We're building a Bernedoodle page and would love a short quote or tip from you — anything you wish new Bernedoodle owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Moose the Mini Bernedoodle** — form: moosebernedoodle.com/contact-us · IG @moose_bernedoodle
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Moose's tips posts — especially the dog-friendly travel ones — are a great read. We're building a Bernedoodle page and would love a short quote or tip from Moose's humans — anything you wish new Bernedoodle owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Chewy the Bernedoodle** — form on site · IG @chewy_bernedoodle
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Chewy's grooming/training/travel posts from San Jose are charming — I'd love to see the blog get a fresh outing. We're building a Bernedoodle page and would love a short quote or tip from you — anything you wish new Bernedoodle owners knew — credited with a link back to your site. Happy to write an original piece for Chewy's blog too, your topic, no cost. Worth a chat? — James

**Alpine Bernedoodles** — form: alpinebernedoodles.com/contact-us/ *(verified, active)*
> Hi Kathryn — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your 16 years as a vet tech clearly shape how you raise your Mini and Micro Bernedoodles — that depth is rare. We're building a Bernedoodle page and would love a short quote or tip from you — anything you wish new Bernedoodle owners knew — credited with a link back to alpinebernedoodles.com. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

### German Shepherd (4)

**German Shepherd 101** — about/contact: germanshepherd101.com/about/ · FB
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your owner's-guide and training write-ups are some of the most thorough GSD resources out there. We're building a German Shepherd page and would love a short quote or tip from you — anything you wish new GSD owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**World of Dogz (Sharon Waddington)** — form: worldofdogz.com/contact/
> Hi Sharon — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Nearly 30 years as a British police officer is quite a lens to bring to your German Shepherd writing. We're building a German Shepherd page and would love a short quote or tip from you — anything you wish new GSD owners knew — credited with a link back to worldofdogz.com. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**German Shepherd Dog HQ** — verify contact at germanshepherddoghq.com/contact/
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your deep coverage of GSD mixes is a corner of the breed most sites skip. We're building a German Shepherd page and would love a short quote or tip from you — anything you wish new GSD owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Shepherd Sense (Catherine)** — form: shepherdsense.com/contact-page/ *(dormant since 2021)*
> Hi Catherine — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your psychology and animal-behavior background gives your GSD posts a real edge. We're building a German Shepherd page and would love a short quote or tip from you — anything you wish new GSD owners knew — credited with a link back to your site. Happy to write an original piece for your blog too, your topic, no cost. Worth a chat? — James

### Mini Golden Retriever (3)

**Robyn's Nest Mini Goldens** — form: robynsnestminigoldens.com/contact/
> Hi Robyn — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your family-run program out in the Ozarks — and how regularly you post — is exactly the real-owner voice I'm after. We're building a Mini Golden Retriever page and would love a short quote or tip from you — anything you wish new Mini Golden owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Pacific NW Mini Goldens** — form: pnwminigoldens.com/contact/ · IG @pnwminigoldens
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your small family program up in the PNW and the care in your breed write-ups stood out. We're building a Mini Golden Retriever page and would love a short quote or tip from you — anything you wish new Mini Golden owners knew — credited with a link back to your site. Happy to write an original piece for your site too, your topic, no cost. Worth a chat? — James

**Little Retriever Ranch** — form: littleretrieverranch.com/contact/ · IG @littleretrieverranch
> Hi Sarah & Michelle — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. A mother-daughter Mini Golden program in Santa Barbara is a lovely story. We're building a Mini Golden Retriever page and would love a short quote or tip from you — anything you wish new Mini Golden owners knew — credited with a link back to your site. Happy to write an original piece for your site too, your topic, no cost. Worth a chat? — James

### Australian Labradoodle (2)

**Snooze & Sniff (Alina Varga)** — form on site
> Hi Alina — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your "Australian Labradoodle vs Labradoodle" comparison posts are some of the clearest I've found. We're building an Australian Labradoodle page and would love a short quote or tip from you — anything you wish new ALD owners knew — credited with a link back to snoozeandsniff.com. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Royal Australian Labradoodles (Chelsea Johnson)** — form: royalaustralianlabradoodles.com/contact-us/ *(blog dormant since 2024)*
> Hi Chelsea — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your breed-info library is a solid resource — I'd love to help give the blog a fresh post. We're building an Australian Labradoodle page and would love a short quote or tip from you — anything you wish new ALD owners knew — credited with a link back to your site. Happy to write an original piece for your blog too, your topic, no cost. Worth a chat? — James

### Labradoodle (2)

**Snowy River Labradoodles** — form: snowyriverdoodle.com/contact-us/
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Yours might be the most active doodle blog I've come across — the agility, swimming and paw-care posts are great. We're building a Labradoodle page and would love a short quote or tip from you — anything you wish new Labradoodle owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Loveable Labradoodles (Becky Puckett)** — form: loveablelabradoodles.com/contact-form
> Hi Becky — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your "Why Australian Labradoodles Make the Perfect Family Pet" piece is right on the money. We're building a Labradoodle page and would love a short quote or tip from you — anything you wish new Labradoodle owners knew — credited with a link back to your site. Happy to write an original piece for your blog too, your topic, no cost. Worth a chat? — James

### Saint Berdoodle (1)

**Mason Creek Saint Berdoodles** — form: masoncreeksaintberdoodles.com/contact-us.html *(winding down by 2027)*
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your detailed "About the Breed" section is one of the better Saint Berdoodle primers around. We're building a Saint Berdoodle page and would love a short quote or tip from you — anything you wish new Saint Berdoodle owners knew — credited with a link back to your site. Happy to write an original piece for your site too, your topic, no cost. Worth a chat? — James

### Mini Aussie (3)

**Blue Buckaroo Aussies** — form: buckarooaussies.com/contact-us/
> Hi there — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your "Can You Work Full Time and Have a Mini Aussie?" post is exactly the honest, owner-first writing I love. We're building a Mini Aussie page and would love a short quote or tip from you — anything you wish new Mini Aussie owners knew — credited with a link back to your site. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

**Kicks and Giggles Mini Aussies (Cathy Lewis)** — form: kicksandgigglesminiaussies.com/contact-us/ · phone (207) 319-5956
> Hi Cathy — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your personal puppy blog up in Maine has such a warm voice. We're building a Mini Aussie page and would love a short quote or tip from you — anything you wish new Mini Aussie owners knew — credited with a link back to your site. Happy to write an original piece for your blog too, your topic, no cost. Worth a chat? — James

**Run'n Bear Mini Aussies (Bill & Alice)** — form: mini-australian-shepherds.com/contact/ *(verified, active)*
> Hi Bill & Alice — I run The Dog Show (dogshow.lol), a live online dog show where people enter their dogs and the crowd cheers them on. Your whole "a Mini Aussie that fits your life, doesn't take it over" philosophy really resonated. We're building a Mini Aussie page and would love a short quote or tip from you — anything you wish new Mini Aussie owners knew — credited with a link back to mini-australian-shepherds.com. Happy to return the favor with an original article for your blog, your topic, no cost. Worth a chat? — James

---

# WAVE 1 — 23 high-value breeds (added 2026-06-23)

Prospects for the 12 already-live pages + 11 next-to-build breeds. All URLs were fetched/verified by the research pass; emails listed only where literally seen on-page. Each entry carries a **hook** (the real personalized detail to use when you write — per the always-personalize rule). Personalized messages not yet written for these — say the word and I'll draft them (or Gmail drafts for the verified-email ones) like the first 19.

## Roadmap read — community depth by breed

This is the launch-roadmap signal *before* a single reply: how deep the pool of linkable owner-blogs is. **Rich** = many genuine owner blogs (best backlink + guest-post soil). **Thin** = mostly breeder/marketplace sites, few true blogs (outreach still works but skews to breeders; for not-yet-built breeds, a reason to deprioritize launching).

| Depth | Breeds |
|---|---|
| **Rich** | Goldendoodle, Pomsky, Mini Dachshund, Cockapoo, Cavapoo, Bernese Mountain Dog, Vizsla, Mini French Bulldog, American Bully |
| **Moderate** | French Bulldog, Cane Corso, Belgian Malinois, Newfoundland, Giant Schnauzer, Chocolate Lab |
| **Thin** | Teacup Poodle, Golden Mountain Dog, Toy Aussie, Maltipoo, Dalmatian, Maltese, Agouti Husky |

**Of the not-yet-built breeds:** Bernese Mountain Dog, Vizsla, Mini French Bulldog, and American Bully have rich communities (strong launch candidates); Maltese and Agouti Husky are thin (Agouti is a coat color, not a breed — expect breeder-only) and weaker launch bets on this signal alone.

Legend — ✉️ verified on-page email · 📝 contact form · 📱 phone/DM · ❓ verify before sending.

### Goldendoodle *(live · Rich)*
- **GoldenLife Doodles** — goldenlifedoodles.com — breeder, active blog (Houston) — ✉️ support@goldenlifedoodles.com — High — *hook: blog posts fresh through May 2026*
- **Matthews Legacy Farm** — matthewslegacyfarm.com — family breeder blog (UT) — ✉️ Matthewslegacyfarm@gmail.com — High — *hook: warm story-driven brand around dog Dixie*
- **Happy-Go-Doodle** — happygodoodle.com — award-winning owner blog (Jenise, dog Chloe) — 📝 — High — *hook: BlogPaws Best New Pet Blog winner; highest authority*
- **Goldendoodles.com** — breed-info hub (Blue Sterling) — ✉️ blue@goldendoodles.com — Med-High — *hook: runs a monthly photo contest (maps to a dog show)*
- **Timberidge Goldendoodles** — timberidgegoldendoodles.com — family breeder blog — ❓ email unverified — High

### Pomsky *(live · Rich)*
- **Pomsky Dog Blog** — pomskydogblog.com — dedicated breed-info blog — 📝 — High — *hook: a pure Pomsky content blog that links out to resources*
- **KP Pomskies** — kppomskies.com — breeder, ~40-article library — 📝 — High — *hook: owner Kimberly is Dir. of Education at the American Pomsky Kennel Club*
- **Pomsky Owners Association** — pomskyownersassociation.com — breed-association hub — 📝 — High — *hook: self-styled leading authority for the breed*
- **My Crazy Pomskys** — mycrazypomskys.com — breeder blog + lifestyle — 📝 (email obfuscated) — High — *hook: "Everyday Life" lifestyle section, updated June 2026*
- **Brookside Pomskies** — brooksidepomskies.com — family breeder blog — 📝 — High

### Teacup Poodle *(live · Thin — breeder/marketplace heavy)*
- **Galavanting Poodles** — galavantingpoodles.com — owner blog (Melissa, Alaska) — ❓ form — High — *hook: "The Poodle Blog," genuine Alaska-poodle owner voice*
- **KC Poodles of PA** — kcpoodlesofpa.com — breeder w/ teacup education page — ❓ — High
- **Happytail Puppies** — happytailpuppies.com — commercial marketplace blog — 📝 — Med-High — *secondary; not owner-run*

### Mini Dachshund *(live · Rich)*
- **You Did What With Your Wiener** — youdidwhatwithyourweiner.com — authority blog (Jessica) — ✉️ Jessica@pettalkmedia.com — High — *hook: "the dachshund life coach," explicitly works with brands*
- **I Love Dachshunds** — ilovedachshunds.com — breed blog UK (Alison Fleming) — ✉️ woof@ilovedachshunds.com — High — *hook: 10+ yr dachshund resource*
- **Patti's Dachshund Farm** — pattisdachshundfarm.com — breeder blog (Patti) — ✉️ pg9365@juno.com — High
- **Crème of the Crop Dachshunds** — cremeofthecropdachshunds.com — breeder — ❓ verify contact — Med

### Golden Mountain Dog *(live · Thin — breeder-only, no owner blogs found)*
- **Golden Mountain Farm** — goldenmountainfarm.com — breeder w/ blog (Sarah) — ✉️ goldenmountainfarm@outlook.com — High — *hook: actually markets Golden Mountain Dogs + has a blog*
- **Golden Mountain Dogs** — goldenmtndogs.com — breeder, no blog (Ali) — ✉️ pups@goldenmtndogs.com — High — *hook: entire site is the breed*
- **Oak Creek Berners** — bernerpuppy.com — breeder, no blog (Michael) — ✉️ bernerpuppy.com@gmail.com — High

### Toy Aussie *(live · Thin — breeder-only)*
- **Flying Walker Toy Aussies** — flyingwalkertoyaussies.com — breeder, info pages (Kary, vet tech) — ✉️ kary@flyingwalkerranch.com — High
- **Keldrew Ranch** — keldrewranch.com — breeder, breed-info (Kelli & Andrew) — 📝 — High — *hook: site stamped updated 6/16/2026*
- **Magical Toy Aussies** — magicaltoyaussies.com — breeder education (Shawna) — ✉️ magicaltoyaussies@gmail.com — Med-High
- **Misty's Toy Aussies** — mistystoyaussies.com — breeder (Misty) — ✉️ misty@mistystoyaussies.com — Med — *possibly dormant since 2022*

### French Bulldog *(live · Moderate — commercial-heavy)*
- **French Bulldog Owner** — frenchbulldogowner.com — owner blog (Marc & Jemma, dog Claude) — 📱 YouTube/no email — High — *hook: real-life owner content since 2018*
- **My Pawesome Frenchie** — mypawesomefrenchie.com — breeder blog (Toronto) — 📝 — High
- **French Bulldogs HQ** — frenchbulldogshq.com — owner blog (dog Fendi, chocolate merle) — ❓ form — Med-High
- **Frenchie Journey** — frenchiejourney.com — owner blog — ❓ Low (couldn't confirm live)

### Cockapoo *(live · Rich)*
- **Reggie the Cockapoo** — reggiethecockapoo.co.uk — IG influencer + site (Suzanne, 40k+ IG) — ✉️ reggiethecockapoo@gmail.com — High — *hook: Reggie is a dog model/reviewer, open to collabs*
- **Felindre Cockapoos** — felindrecockapoos.co.uk — breeder blog (UK) — ✉️ info@felindrecockapoos.co.uk — High — *blog cadence slowed since 2024*
- **Freya the Cockapoo** — freyathecockapoo.com — owner blog UK (Freya & Frankie) — 📱 IG @freya.and.frankie — High — *hook: independent reviewer, no paid alliances*
- **Cockapoo Owners Club UK** — cockapooownersclubuk.weebly.com — community site — ❓ — Med

### Maltipoo *(live · Thin)*
- **PetMaltipoo** — petmaltipoo.com — comprehensive breed-info site — ✉️ Contact@PetMaltipoo.com — High — *hook: the most complete Maltipoo-only resource online*
- **My Doodle Puppy** — mydoodlepuppy.com — breeder w/ "Write For Us" (covers Maltipoo/Cockapoo/Cavapoo) — 📝 — High — ⚠️ *charges $100/article — paid placement, not a free link*
- **My Pet Tales Book** — mypettalesbook.com — multi-breed info, has a Maltipoo guide — ❓ — Med

### Cavapoo *(live · Rich)*
- **Cavapoo Crew** — cavapoocrew.com — owner blog (Colin, dog Arlo) — 📝 — High — *hook: explicitly accepts guest posts (no AI content) — highest-intent prospect*
- **CavapooLove** — cavapoolove.com — owner blog (Irma, dog Tucker) — ✉️ info@cavapoolove.com — High — *hook: 40+ yrs dog breeding/showing experience*
- **Cavapoo Journal** — cavapoojournal.com — owner blog (Howell Bigham, dog Opie) — 📝 (email obfuscated) — High

### Cane Corso *(live · Moderate — breeder-heavy)*
- **Cane Corso Dog Owner** — canecorsodogowner.com — owner blog (Robert Hawkins & Lucinda, dogs Maud & Hermie) — 📝 — High — *hook: 13-yr owners, "we tell it like it is"*
- **Sikania Kennel** — canecorsosikania.com — breeder blog (Marco & Saverio) — ❓ email unconfirmed — Med
- **PRIDENJOYZ** — pridenjoyzcanecorso.com — breeder blog — ❓ email unconfirmed — Med

### Dalmatian *(live · Thin)*
- **Dalamanti** — dalamanti.co.uk — breeder/exhibitor (Lisa Barrett), no blog — ✉️ lisa@dalamanti.co.uk — High — *hook: her dog Yogi won Post Graduate at Crufts 2025*
- **Dalmatian Friends** — dalmatianfriends.com — owner blog (Brandon Bartlett, dog Penny) — 📱 IG @dalmatianfriends — Med-High — *blog quiet since 2024, IG active*
- **The Dalmatian Association (UK)** — thedalmatianassociation.org.uk — breed association — ❓ — High but institutional

### Belgian Malinois *(not built · Moderate)*
- **Blackwood Canine** — blackwoodcanine.com — trainer/owner blog (David Wright) — ✉️ info@blackwoodcanine.com — High — *hook: candid "Malinois, True Talk" posts*
- **Dark Malinois** — darkmalinois.com — breeder blog (Martha Achaval, FL) — ✉️ darkmalinois18@gmail.com — High
- **KSDK Malinois** — ksdkmalinois.com — working-line breeder, no blog (Tongtong Zhou) — ✉️ tongtong_zhou@yahoo.com — High

### Bernese Mountain Dog *(not built · Rich)*
- **Kevin The Berner** — kevintheberner.com — owner/influencer blog — ✉️ kevintheberner@gmail.com — High — *hook: a "dog persona" brand with a "Let's Work Together" page*
- **TheBernese.org** — breed-info site, very active — 📝 — High — *hook: deep care/health library dated 2025-26*
- **BernerWise** — bernerwise.com — owner blog (Eileen Blass) — ❓ no email, stale posts — Med — *hook: owner is a former USA TODAY staff photographer*

### Maltese *(not built · Thin)*
- **Maltese Maniac** — maltesemaniac.com — owner-run fan site — 📝 (no email confirmed) — Med-High — *hook: whole site is owners showing off their Maltese*
- **PetMaltese.com** — Maltese info center — ❓ contact unverified — Med
- *Gap: no solid 3rd owner-blog found. Maltesesavvy.com wouldn't load; American Maltese Assoc. is a club, not a blog. Thin breed — confirm before treating as a launch priority.*

### Vizsla *(not built · Rich)*
- **The Dog Walks Me** — thedogwalksme.com — owner adventure blog (Adele, dogs Whiskey & Bourbon, BC) — 📝 — High — *hook: posts dated March 2026, adventure-Vizsla angle*
- **HRQ Vizslas** — hrqvizslas.com — breeder news-blog (Susan Sibley, Napa) — 📝 — High
- **Belatarr** — belatarr.co.uk — UK show kennel blog — 📝 — High — *note: wirehaired Vizsla variant*
- **redbirddog** — redbirddog.blogspot.com — owner blog (Rod Michaelson) — 📱 Blogger only — Med — *tapered since 2023*

### Newfoundland *(not built · Moderate — 2 strong)*
- **Love Newfoundlands** — lovenewfoundlands.com — owner blog (Niki, dog Niya) — ✉️ lovenewfoundlands@gmail.com — High — *hook: founder of "National Newfoundland Dog Day," has a Work With Me page*
- **My Brown Newfies** — mybrownnewfies.com — owner blog (Jen Costello, retired vet tech) — 📝 (AOL email unverified) — High
- **Belle Harbour Newfoundlands** — bhnewfs.com — breeder (MN) — ❓ — Med

### Giant Schnauzer *(not built · Moderate)*
- **Schnauzer Ranch** — schnauzerranch.com — breeder content-blog (Josh B.) — 📝 — High — *hook: real how-to breed articles through mid-2025*
- **Jordan Giant Schnauzers** — akcgiantschnauzers.com — breeder blog (Tina Jordan) — ✉️ jordangiants@yahoo.com — High — *freshness medium (2022)*
- **Skyline Giant Schnauzers** — skylinegiantschnauzer.com — breeder, "Owner Stories" pages — 📝 — Med — *footer © 2017, verify activity*

### Chocolate Lab *(not built · Moderate — breeder blogs)*
- **Hidden Pond Labradors** — hiddenpondlabradors.com — breeder blog (David Cortland) — ✉️ David@HiddenPondLabradors.com — High — *hook: dedicated chocolate-Lab pages*
- **Overlook Labradors** — overlookmtlabradors.com — breeder blog (Gina & Mark Rothe, Catskills) — 📝 — High — *hook: 50+ posts, newest April 2026*
- **Three Bears Labradors** — threebearslabradors.com — breeder blog (Charles Lockwood) — 📝 — High — *hook: "Essential Guide to Chocolate Lab Puppies," Oct 2025*
- **Moose & Mary Labradors** — mooseandmarylabs.com — breeder blog (Corey Wolfenbarger, TN) — 📝 — Med

### Mini French Bulldog *(not built · Rich)*
- **FrenchieChat** — frenchiechat.com — owner blog + newsletter — 📝 — High — *hook: openly solicits guest content/photo features*
- **OnlyFrenchBulldog** — onlyfrenchbulldog.com — owner blog (Ana White) — 📝 — High — *hook: updated May 2026*
- **You Winnie Some Frenchies** — youwinniesomefrenchies.com — breeder blog (Rachelle Fox, CA) — 📝 — High
- **Micro Frenchies** — microfrenchies.com — breeder, mini/teacup-aligned (Houston) — 📱 phone — Med-High — *most keyword-aligned to "mini/teacup"*
- **French Bulldog Owner** — frenchbulldogowner.com — *(same as in French Bulldog list — pitch once)*

### Mini Australian Shepherd *(not built · overlaps Mini Aussie — mostly already covered)*
- ⚠️ **Heavy overlap with the Mini Aussie list (Wave 0):** Run'n Bear, Blue Buckaroo (✉️ info@buckarooaussies.com, owner Nicole), Painted Blue Aussies are the same sites. Don't double-pitch.
- **Karen Shanley** — karenshanley.com — personal author blog w/ a Dogs section — 📝 — Med — *hook: wrote a first-person Mini vs Standard Aussie piece (only net-new prospect here)*

### American Bully *(not built · Rich)*
- **Capcity Bullys** — capcitybullys.com — breeder education blog — ✉️ johnwcolumbus@gmail.com — High — *hook: monthly long-form care/training posts through May 2026*
- **Venomline** — venomlinebullies.com — breeder/content hub — 📝 — High — *hook: huge SEO blog hub, already links out to ABKC/OFA/Embark*
- **American Bully Lover** — americanbullylover.com — pure content blog (evelin) — 📝 — Med-High
- **American Bully Daily** — americanbullydaily.com — content site (Max Alvarado) — 📝 — Med — *possibly dormant since 2020*

### Agouti Husky *(not built · Thin — Agouti is a color, not a breed)*
- **Bama Huskies** — bamahuskies.com — breeder, agouti-specific blog (Jim Wood, AL) — 📱 phone/form — High — *hook: has a "What Is an Agouti Husky?" article; markets agouti directly*
- **Halo Huskies** — halohuskies.com — breeder w/ agouti bloodline (AL) — 📱 phone (email obfuscated) — High
- **Husky Advisor** — huskyadvisor.com — active general-husky owner blog (Alexa) — 📱 social (email obfuscated) — High — *most active publisher, not agouti-only*
- **Southern Siberian Life** — southernsiberianlife.com — hobby breeder blog (AL) — 📝 — Med-High

## Dedup / honesty notes for Wave 1
- **Mini Australian Shepherd ≈ Mini Aussie ≈ Toy Aussie** overlap heavily — Run'n Bear, Blue Buckaroo, Painted Blue Aussies recur. Treat as one outreach pool; pitch each site once.
...
**Overflow — verified emails, NOT yet drafted (cap):** American Bloodhound Club (secretary@americanbloodhoundclub.org) + Plum Creek Kennels (plumcreekkennels@gmail.com) — **both DRAFTED in Wave 11 (2026-07-14)**. **Held for sensitivity:** Vom Hallynn Haus (vomhallynnhausk9s@gmail.com — homepage memorials).

---

# WAVE 11 — 6 long-tail breeds (researched 2026-07-14)

All sites fetched + verified live 2026-07-14. Emails reported only where literally seen on-page. Legend as above.

### Cairn Terrier *(1 clean email; scene is club/form-heavy)*
- **Northwest Cairn Terriers** — northwestcairnterriers.com — breeder w/ real blog + community events (Leilani Nichols, Longview WA) — ✉️ **info@northwestcairnterriers.com** (site header + footer, every page) — High (Jan 2026 post "Coat Types In Cairn Terriers"; 2026 waitlist open) — *hook: hosts the annual "Toto Walk" — third annual Summer 2026, ~40 Cairns* — **DRAFTED**
- **McWilliams Terriers** — mcwilliamsterriers.com — breeder/AKC exhibitors (James Meinecke & Rebecca McWilliams, Lewis Farm, Concord NH) — 📝 homepage form (reCAPTCHA) — High (puppies due June 2026) — *hook: AKC CH "Faehallow Maximus Decimus McWilliams" (Max); Skye + Ruby chasing championships* — MANUAL — ⚠️ homepage SCAM WARNING (impostor FB page using mcwilliamsterriers@gmail.com — NEVER use that address; footer email rebecca@independentdesign.com is their web designer's, not drafted); first-Cairn Libby story is a "why we breed" memorial — gentle tone
- **The Cairn Terrier Club (UK)** — thecairnterrierclub.co.uk — breed club est. 1910 — 📝 /contact/ (Hon. Secretary; volunteer-run, slow replies) — High (AGM post 4 Jul 2026; "Cairn Café" 27 Jun 2026) — *hook: the Cairn Café community event just got a second edition; motto "The Best Little Pal in the World"* — MANUAL
- **Cairn Terrier Club of Southern California** — cairnterrier.net — regional AKC club + rescue — 📝 /contact-club-officers/ (phone (760) 728-7133 Karen Smith, Secretary) — High (modified Jul 2026) — *hook: they sell their own "Grooming Your Cairn Terrier" DVD* — MANUAL — ⚠️ never route via their rescue questionnaire. *(Rejected: writetowag = wordpress.com subdomain; Marma's = JS shell, unverifiable; cairntalk = forum.)*

### Chesapeake Bay Retriever *(3 clean emails; all breeders — no active own-domain owner-blogs exist)*
- **LongMeadow Chesapeakes** — longmeadowkennels.com — breeder (Dover PA, license #4226) — ✉️ **info@longmeadowchesapeakes.com** (homepage top banner + footer) — High (advertising 2026 litters now) — *hook: "Teen Puppy Care Givers" program + half-price local Breeding Rights Program* — **DRAFTED**
- **CopperCast Chesapeakes** — coppercastchesapeakes.com — breeder (Mitchel & Diane Horowitz, Trappe MD — on the actual Chesapeake) — ✉️ **mitchel@coppercastchesapeakes.com** (footer, every page + 631-834-8893) — Med (real; © 2014, freshness unproven) — *hook: kennel named for foundation dog Tonka (mBISS Gr. Ch) "and his cast of characters"; preserving the ALL-purpose CBR* — **DRAFTED**
- **Weatherdeck Chesapeakes** — weatherdeckchesapeakes.com — hobby kennel + blog (Gina Downin & Thomas Rick, Mt. Rainier MD) — ✉️ **gina@weatherdeckchesapeakes.com** (homepage footer) — Med real / Low-Med active (last post Nov 2021) — *hook: Yoomee's gundog training holiday in St. Moritz* — **DRAFTED** (fresh-outing framing) — ⚠️ blog holds a memorial (CH Weatherdeck Boatswain) — reply gently
- **Camptown Chesapeakes** — camptownchesapeakes.com — breeder (Hudson Valley NY, est. 1990) — 📝 /contact-us.html + (845) 361-4761, no email — High (summer 2026 litter: CH Buddy × CH Smalla) — *hook: their dog Lago appears in YETI Coolers advertising* — MANUAL
- **Wingmaster Kennel** — wingmasterkennel.com — breeder/trainer (Eastern Shore VA, 30 yrs) — 📱 757-442-5500; email Cloudflare-obfuscated, UNVERIFIED — High active (March 2026 photo of 12½-yr-old JohnHaff) — *hook: "Famous JohnHaff" has his own page; seaside tidal-marsh rail hunts from September* — MANUAL. *(Rejected: Pond Hollow — dormant since 2011 + late-husband/dog memorials front and center; Claddagh Farm — SEO-spam-injected listing; CBR rescue orgs excluded per rescue-inbox rule.)*

### Chinese Crested *(3 clean emails; decent depth)*
- **Qilin Chinese Cresteds** — qilinchinesecresteds.com — breeder w/ real original blog (KY) — ✉️ **qilinchinesecrested@gmail.com** (footer "EMAIL US" mailto, every page) — High (Sep 2025 genetics post; active socials) — *hook: myth-busting post that "hairy hairless" isn't a variety and none should ever be truly bald* — **DRAFTED**
- **Cloud Nine Chinese Cresteds** — cloud9chinesecresteds.com — hobby show breeder + veterinarian (Wendy Ryan DVM, Charlotte NC) — ✉️ **wendyryan667@gmail.com** + sadiebdtel@hotmail.com (both plain text on contact page) — Med-High (8/2025 update banner) — *hook: homebred GCh Maribou now starting an agility career; Tar Heel CCC breeder-referral award (131+ Cresteds placed)* — **DRAFTED** — ⚠️ heavy rescue involvement; pitch kept to show dogs, not adoption
- **Nina's K Chinese Crested** — ninaschinesecrested.com — breeder est. 2005 (Nina Conan, AZ) — ✉️ **Ninaconan1103@gmail.com** (Contact Us section + 480-980-8488) — Med (thin GoDaddy template w/ placeholder text; © 2025) — *hook: foundation dogs are AKC Sires and Dams of Merit* — **DRAFTED** (no blog; softened)
- **Crestie Charm Cottage** — crestiecharmcottage.com — small home breeder (Ocala FL) w/ 11+ post blog — 📝 /contact-us (email redacted behind UENI protection — UNVERIFIED) — High — *hook: "Payback Rewards Program" pays puppy families for earning AKC titles — a breeder incentivizing title-chasing* — MANUAL (best form prospect of the wave)
- **American Chinese Crested Club** — chinesecrestedclub.info — AKC parent club — 📝 /contact-us/ (Corresponding Secretary Angie Patchen; her email is Cloudflare-obfuscated → NOT drafted per Whippet Wonders precedent) — High (Feb 2026 updates) — *hook: 13-yr-old junior Stella Keimon's write-up of her first Westminster with Powderpuff "Mate"* — MANUAL (quote/resource ask; clubs rarely link out). *(Rejected: content farms; Jewels = FB-only; SandStorm/Frozen Star/Shaw = unfetched multi-breed.)*

### Chow Chow *(2 clean emails; thin on active owner blogs)*
- **Chow Chow Tales** — chowchowtales.com — owner blog, rescue-chow storytelling (Jaymes Call / Joy Taylin, LA) — 📝 /contact/, no email — High (modified Jan 2025; pro build, active socials + Etsy "Shandy Shoppe") — *hook: weeks of porch desensitization to get rescue chow Shandy brushed ("Stop Wanting Something From Her!"); Koa's Korner* — MANUAL (best Chow prospect; form only)
- **Misty Mountain Chows** — mistymountainchows.com — family breeder (MD) w/ blog — ✉️ **mistymountainchows@yahoo.com** (footer mailto) — Med-High (blog cadence slow, ~Oct 2024) — *hook: hand-prepared meals with bone broth; rough-coat-only grooming post* — **DRAFTED** — ⚠️ homepage scam warning (stolen photos) — draft leads with plain legitimacy
- **Heavenly Chows** — heavenlychows.com — breeder since 1999 (Emily, MO) — ✉️ **hchows@iland.net** (homepage footer + (573) 378-7966) — Med (live + complete; freshness unproven) — *hook: testimonial dogs Wookie ("was Bruno") and Dexter who chased seagulls into a pool* — **DRAFTED** — ⚠️ self-described USDA-certified commercial-scale breeder — James: brand-fit judgment call before sending
- **Bowens Chow Pals** — bowenschowpals.com — breeder + rescue (Alisha Bowen, Trion GA) — 📝 homepage form + 770-317-4404, no email — High (© 2026) — *hook: 7 generations down from Blueberry who lived to 14½* — MANUAL
- **ChowChow.org** — chowchow.org — community info site + forum since 1995 (Terry Majamaki) — no email on page — Med real / Low active (© 2022) — *hook: began as his 1990s HTML training ground to defend the breed's reputation* — MANUAL/long shot — ⚠️ explicitly says don't contact about rescue. *(Rejected: FlamingStar — last updated 2018; chowchowrs — CAPTCHA wall; profish3 — wordpress.com subdomain.)*

### Coonhound *(2 clean emails; community lives on FB — own-domain blogs thin)*
- **Coonhound & Foxhound Companions** — coonhoundcompanions.com — 501c3 advocacy org (explicitly NOT a rescue), "Long Ears Blog" — 📝 /contact, no email — High (post 11/13/25 "City Living with Coonies") — *hook: they run their own Holiday Photo Contests — natural bridge to a live online dog show* — MANUAL (best Coonhound prospect; form only) — ⚠️ contact page bolds "we are NOT a rescue" — make the ask obviously non-rehoming
- **The Family Coonhound** — thefamilycoonhound.com — owner blog (Janet Coy; companion/adoption-advocacy, non-hunting) — ✉️ **thefamilycoonhound@gmail.com** (plain text, bottom of "All About Hounds" page) — Med (real + personal; last post May 2022) — *hook: her mission to push coonhounds above #128 in AKC popularity — maps directly to our voting; Riley B + barn-possum-catcher Baker* — **DRAFTED** (fresh-outing framing)
- **Davis Branch Blueticks** — davisbranchblueticks.com — breeder since 2004 (Wendy Davis, Shelbyville TN) — ✉️ **HARLEYSandHOUNDS@yahoo.com** (contact page plain text + 931-703-2101) — Med (live; newest narrative ~2012) — *hook: bred Smokey X, the University of Tennessee's live bluetick mascot; featured on Animal Planet's Dogs 101* — **DRAFTED** (no blog; softened)
- **Phipps Big Game Hounds** — phippsbiggamehounds.com — Bluetick hunting breeder (Steve Phipps, UT) — 📝 /contact-us/ + text 541-815-6086; email Cloudflare-obfuscated, UNVERIFIED — Med-High (homepage modified Feb 2026) — *hook: 1980s work with Oregon's Black Bear Biologist radio-collaring bears; youth football team named "the Blueticks" after his kennel* — MANUAL — ⚠️ hunting-kennel content (bear/lion) — brand-fit judgment call. *(Rejected: Front Range — FB-only; assorted content farms/directories.)*

### English Setter *(2 clean emails drafted; richest blog scene of the wave)*
- **October Setters** — octobersetters.com — Ryman-type breeder w/ very active blog (Cliff & Lisa Weisse, Island Park ID) — ✉️ **info@octobersetters.com** (contact page: "email is the best way to reach us Oct–Jan") — High (July 2026 "First Look At Autumn and Lily Litters") — *hook: that litter post + unusually deep breed-health section* — **DRAFTED**
- **EvrSett English Setters** — evrsett.com — show breeder 25+ yrs (Joanna Jacobson-Lottig + family, WI/TN) — ✉️ **joanna.lottig@yahoo.com** (contact page plain text; also gladysjacobson@ / ljacobson22@) — Med-High (news ~Fall 2025) — *hook: Poppy finished her championship; kids' Junior Showmanship wins at the Ohio specialty* — **DRAFTED** — ⚠️ homepage scam warning (puppy impersonators) — draft leads with plain legitimacy; ⚠️ recent news mentions several setter deaths (Inara et al.) — avoided in draft, reply gently
- **My English Setters** — myenglishsetters.com — owner blog (Emily & Nathan, western KY) — 📝 /contact/, no email — High (post "Brady's Story" June 7, 2026) — *hook: new setter Brady joining Ivy Jane; Emily works in marketing for a sporting-goods company — she'll get the pitch instantly* — MANUAL (best form prospect) — ⚠️ their setter Winston died of cancer July 2024, chemo posts still on homepage — reference Brady/Ivy Jane warmly, never Winston breezily
- **RymanSetters.com** — rymansetters.com — multi-breeder collective blog (~16 kennels incl. October Setters) — ✉️ founders@rymansetters.com is a breeder-membership inbox — High active — *hook: the Icelandic outcross project (Hafrafells Mori)* — **NOT DRAFTED** (membership inbox + overlaps October Setters this batch — possible later relationship play)
- **Hickory Hollow Llewellins** — hickoryhollowllewellins.com — Llewellin (FDSB) breeder (Jeff & Jen Hancock, Manhattan KS) — 📱 phone only (877.GUN.DOGS), no email found — High ("Updated July 6, 2026"; 24/7 live puppy cam) — *hook: Jeff's first bird dog from his grandpa at age 9; first setter Tater in 2000* — MANUAL — note: Llewellin-branded (AKC counts them as English Setters — tailor pitch). *(Rejected: abetteresetter.org — rescue inbox; settersunlimited — directory; Setter Ridge — unfetched, worth a later look.)*

## Wave 11 draft messages (15 staged 2026-07-14)

All follow the standard template with these per-prospect personalizations (full text lives in the Gmail drafts):
1. **Northwest Cairn Terriers** (info@northwestcairnterriers.com, "Hi Leilani") — the Toto Walk (~40 Cairns in Longview) + Jan coat-types post.
2. **LongMeadow** (info@longmeadowchesapeakes.com) — Teen Puppy Care Givers program; 2026 litters on the board.
3. **CopperCast** (mitchel@coppercastchesapeakes.com, "Hi Mitchel") — Tonka "and his cast of characters"; Eastern Shore; ALL-purpose CBR.
4. **Weatherdeck** (gina@weatherdeckchesapeakes.com, "Hi Gina") — Yoomee's St. Moritz training holiday; fresh-outing framing; memorial avoided.
5. **Qilin** (qilinchinesecrested@gmail.com) — hairless-genetics myth-busting ("none should ever be truly bald").
6. **Cloud Nine** (wendyryan667@gmail.com, "Hi Wendy") — vet + GCh Maribou starting agility; show-dog framing, no adoption talk.
7. **Nina's K** (Ninaconan1103@gmail.com, "Hi Nina") — 20 years; AKC Sires/Dams of Merit; softened (no blog).
8. **Misty Mountain** (mistymountainchows@yahoo.com) — bone-broth meal prep + rough-coat grooming post; legitimacy made plain up front (scam warning).
9. **Heavenly Chows** (hchows@iland.net, "Hi Emily") — Wookie + Dexter-and-the-seagulls testimonials; softened (no blog). ⚠️ USDA-commercial — James decides.
10. **The Family Coonhound** (thefamilycoonhound@gmail.com, "Hi Janet") — the #128-ranking mission mapped to our voting; Riley B + Baker; fresh-outing framing.
11. **Davis Branch** (HARLEYSandHOUNDS@yahoo.com, "Hi Wendy") — Smokey X cheered by 100,000 on Saturdays; Dogs 101; softened (no blog).
12. **October Setters** (info@octobersetters.com, "Hi Cliff and Lisa") — Autumn & Lily litters congrats + the health section.
13. **EvrSett** (joanna.lottig@yahoo.com, "Hi Joanna") — Poppy's championship + Junior Showmanship wins; legitimacy made plain (scam warning); deaths avoided.
14. **American Bloodhound Club** (secretary@americanbloodhoundclub.org) — Wave 10 overflow; "get LOST!" bumper sticker; complementary framing + 2026 National Specialty nod.
15. **Plum Creek Kennels** (plumcreekkennels@gmail.com, "Hi Art and Mary") — Wave 10 overflow; inheriting the premier US French Brittany kennel from the Dillons.

---

# WAVE 12 — 6 long-tail breeds (researched 2026-07-15)

All sites fetched + verified live 2026-07-15. Emails reported only where literally seen on-page. Legend as above.

### English Springer Spaniel *(2 clean emails; healthy scene for a popular breed)*
- **Molly Paws Up** — mollypawsup.com — owner blog (Tomasz Wzorek & wife, UK; working Springer "Molly") — ✉️ **fetch@mollypawsup.com** (body Cloudflare-obfuscated BUT the page's own meta description literally says "feel free to email us at: fetch@mollypawsup.com" — explicit contact copy, so treated as verified; distinct from the Whippet Wonders case) — High (posting through Aug 2025) — *hook: "Why You Shouldn't Get a Springer Spaniel" — talks readers OUT of the breed* — **DRAFTED** — note: a post mentions losing their cat — not referenced
- **Gulf Coast English Springer Spaniels** — gulfcoastspringerspaniels.com — breeder (Carol Farmer, East Milton FL; AKC Breeder of Merit) — ✉️ **Farmerclary@gmail.com** (contact page plain text w/ address + phone) — High (newborn-puppies banner current) — *hook: homepage congrats to Zofie & Pat Gleich on becoming a certified therapy dog team* — **DRAFTED** (no blog; softened) — ⚠️ their Facebook page was disabled "out of our control" — not referenced
- **SpringerSpaniel.org** — springerspaniel.org — owner-run hub-in-progress (Tabby, 27 yrs with Springers; inherited the domain from the closed ESSCLI-R rescue) — no email on fetched pages, newsletter only — Med — *hook: saved the 1988-founded rescue's domain from "the internet black hole"; wants to be "the hub of all things ESS" — plausibly link-hungry* — MANUAL/verify (check for a contact page; content still thin)
- **ESSFTA** — englishspringerspaniels.org — AKC parent club (est. 1926 — centennial year) — no verified email on homepage (admin@ appears only as a WP author byline — not used); Officers page for contacts — High — *hook: 2026 National Specialty Oct 9 in their centennial year* — MANUAL (clubs rarely link; long shot)
- **AJ the Springer** — ajthespringer.com — owner blog (Jean Stemp, ID; rescue Springer A.J.) — no contact method at all — Med — ⚠️ A.J. is ~13-14 and posting is sparse (one Oct 2024 post after a 3-yr gap) — SKIP (no channel + sensitivity). *(Dead ends: sonorahillsess.com + springerspanielsavvy.com fetched empty — unverified, excluded.)*

### Greyhound *(2 clean emails drafted + 1 dormant overflow; owner-blog scene thin — culture moved to IG/FB, adoption orgs carry the wave)*
- **Berry's Wonder Hounds** — berryswonderhounds.com — owner/foster blog (UK; greyhound "Niko") — ✉️ **bwhounds@outlook.com** (contact page: "please feel free to drop me a message" mailto) — High (post 30 Dec 2025; active comments) — *hook: "Greyhounds and Little Humans" post + "our gorgeous snooty, Niko"* — **DRAFTED** — ⚠️ blogger writes openly about anxiety + galgo-cruelty topics — warm sincere tone, no irony, reply gently
- **Greyhound Friends for Life** — greyhoundfriendsforlife.org — adoption org (SF Bay Area) w/ very active news blog — ✉️ **greyhoundfriendsforlife@gmail.com** (plain text top of homepage) — High (posts July 2, 2026) — *hook: June 21 reunion-photos post; adoptable Millie* — **DRAFTED** (adopter angle, racing-neutral)
- **Greyhound Pets, Inc.** — greyhoundpetsinc.org — adoption org (Woodinville WA, 63-page blog archive) — email Cloudflare-obfuscated, UNVERIFIED (form + 877-468-7681) — High (post July 13, 2026) — *hook: their "Dog of the Month" feature (July: Alfie, racing name "Swift Inception") — direct parallel to our Dog of the Month race* — MANUAL (best form prospect of the breed) — ⚠️ site built by an agency; don't email the agency
- **HoundToday** — houndtoday.com — owner-run retired-racer magazine (CH-based, English) — ✉️ **hello@houndtoday.com** (footer mailto) — Med — ⚠️ dormant since ~2022-23 — **NOT DRAFTED this run (cap)** — verified email ready if wanted; "Wagging Tales" reader-story segment is the hook
- **Greyhoundpaddy** — greyhoundpaddy.com — owner blog + small shop (UK; ex-racer Paddy) — 📝 form only — Med-Low (dormant Oct 2023) — *hook: "Paddy's Pawfect Salmon Snaps" treat recipes* — MANUAL/long shot — ⚠️ footer credits "Moni Developer" — never that route. *(Rejected: GREY2K [political advocacy], Oxford Stadium [racing industry], thelovelyhound.com [JS shell, unverifiable].)*

### Irish Setter *(3 clean emails; breeder-heavy — owner blogs dormant since ~2012)*
- **Bright Star Setters** — brightstarsetters.com — breeder (Tracy Czarnecki Leisek, Petaluma CA; Irish + Gordon since 1971) — ✉️ **brightstarsetters@gmail.com** (contact page plain text) — High (June 2026 news; page modified 6/26/26) — *hook: River finished his Championship at the Woofstock shows (June 2026); Declan's Grand Championship at age 2* — **DRAFTED** (no blog; softened; complementary-to-the-ring framing)
- **Erinshire Irish Setters** — erinshireirishsetters.com — breeder (Brenda & Lee Pierhal, Beverly Hills FL; since 1977) — ✉️ **brenda@erinshireirishsetters.com** (homepage: "please call or email me") — High (June 2026 news) — *hook: Paige's litter due ~June 27 — one they "waited 3 yrs" for* — **DRAFTED** (no blog; softened) — ⚠️ self-described "senior years" / "possibly our last litter" — winding down; not referenced
- **Dearg na hEireann** — irishsetterbreeder.com — breeder + therapy-dog trainer (Lesley Winkemann-K'nudson PhD, N. Las Vegas) — ✉️ **Dearg.Na.Heireann@gmail.com** (homepage, twice) — Med-High (Jan/Feb 2026 litter photos; single-page site) — *hook: GCH O'Malley Malone is a registered film/model dog AND certified therapy dog* — **DRAFTED** (softened)
- **Riverwood Irish Setters** — riverwood-irishsetters.com — show kennel (Charlotte Godart, Belgium, EN-language) — body email Cloudflare-obfuscated; og:description meta shows charlottegodart@gmail.com but NOT treated as verified contact copy (contrast Molly Paws Up: no explicit "email us" invite) — form at /contact.html — High active (June 2026 litter; Star was World Winner 2024) — MANUAL via form
- **International Irish Red Setter Club** — iirsc.org — field-trial club, EN/FR/IT — 📝 contact-webmaster form only (sidebar shows unfilled Squarespace placeholder text — ignore it) — Med — *hook: April 2026 European Spring Championship results* — MANUAL/long shot (weakest fit). *(Dead ends: irishsetter.org.uk fetched empty; countryhounds dormant since 2012.)*

### Irish Wolfhound *(3 clean emails; rare breed — owner voice lives inside breeder sites; ⚠️ community has a public feud, stay neutral)*
- **Westover Wolfhounds** — westoverwolfhounds.com — breeder + articles site (Stephanie & Val Westover, Reno NV) — ✉️ **westoverwolfhounds@gmail.com** (footer + phone, © 2026) — High (March 2026 Hunter Creek Trail article + video) — *hook: "The Trail Pack" — backpacking with wolfhounds, horses AND pack goats; Dúghall's bath time* — **DRAFTED** — best prospect of the wave
- **Ballyhara / Dog Blog Musings** — dogblogmusings.com — educator-breeder blog (Lisa Dubé Forman, Schuylerville NY; "educational platform, not a marketing site") — ✉️ **lisa@lisadubeforman.com** (footer + mailto) — Med-High (freshness ~2023-24) — *hook: unusually blunt "Typical Expenses" + "Required Fencing and Acreage" pages — hands people the invoice first* — **DRAFTED** — note: strong natural-rearing/vaccination opinions — kept neutral
- **Bonaforte Irish Wolfhounds** — bonaforte.com — KC Assured Breeder (Carla Durose, UK) w/ two blogs — ✉️ **wolfhounds@bonaforte.com** (footer mailto) — Med (blog dormant since Oct 2023) — *hook: her "I am a dog breeder" essay; accident-prone hound Presto* — **DRAFTED** (fresh-outing framing) — note: a 2018 post feuds with the UK breed Health Group — not referenced
- **Irish Wolfhound Society (UK)** — irishwolfhoundsociety.com — KC-affiliated club — only on-page email is the Breed Education Coordinator's (debtebiwbec@gmail.com — WRONG inbox for this ask, not used); secretary via /officials-and-officers — High (Jan 2026 championship show results) — *hook: their new "Buying an Irish Wolfhound Puppy" guide* — MANUAL (find secretary address first)
- **Boondocks Irish Wolfhounds** — boondocksirishwolfhounds.com — breeder (Troy Pitzenberger) — 📝 form only — Med (blog dormant Jan 2023) — ⚠️ **HIGH SENSITIVITY — DO NOT CONTACT without thought**: blog is call-out content naming breeders as "puppymills" + attacks NIWA; associating with an active feud is brand risk — SKIP recommended. *(Also set aside: NIWA — dormant + the feud's other side; IWCA — too institutional.)*

### Italian Greyhound *(3 clean emails; owner-creator scene is IG/TikTok-only — rescues carry the web presence)*
- **The Italian Greyhound Rescue Charity (UK)** — italiangreyhoundrescuecharity.org.uk — registered charity (Windermere) w/ very active blog — ✉️ **info@italiangreyhoundrescuecharity.org.uk** (footer contact block + 01539 448057) — High (post 18 Apr 2026) — *hook: the Iggy Tea Party fundraiser in Coventry 25 July 2026 (Amy Bracey & Carole Wray)* — **DRAFTED** (rescue/adopter angle; clearly editorial, nothing commercial — they run anti-puppy-farm editorial) — ⚠️ inbox also handles rescue matters; has an In Memory section
- **Italian Greyhound Place** — italiangreyhoundplace.com — non-profit rescue (NY/OH) w/ active news blog — ✉️ **ig@italiangreyhoundplace.com** (footer "Email contact" + homepage mailto) — High (posts 2/25/26; adopted archive through Summer 2026) — *hook: their Feb 2026 note on Westminster IG judging* — **DRAFTED** — ⚠️ the address doubles as their rehoming/intake inbox — draft opens "this isn't a rehoming enquiry" (ABR precedent adapted: here it's the org's only/general address, unlike ABR's dedicated surrender inbox)
- **The Life of Nello** — thelifeofnello.com — owner blog + "IG Masterclass" course (Nello, big IG/TikTok following) — 📝 /contact form; **/collaborations page exists** — Med-High (© 2026; blog content ~2023) — *hook: Nello "looks like a little baby seal" with his ears back; two-iggy pros/cons post* — MANUAL (best form prospect — use the collaborations page)
- **Levriero Italiano (EN edition)** — levrieroitaliano.blog/en/ — enthusiast breed blog (Italian site w/ full English version) — ✉️ **info@levrieroitaliano.blog** (footer) — Med (updated May 2025; non-native English — draft written simply) — *hook: iggies "pretend not to hear you… yet hear the treat bag from 3 km away"* — **DRAFTED**
- **ROMP Italian Greyhound Rescue** — romprescue.com — Chicago rescue — no email on fetched pages; general-inquiry form only — Med real / blog dormant since ~2014 — *hook: their "IGs vs Greyhounds" explainer — the same distinction our page makes* — MANUAL/long shot — ⚠️ never the surrender form. *(Rejected: harvoola [clothing shop first], henninglove [one 2012 post], courtneycourtney [craft blog].)*

### Jack Russell Terrier *(2 clean emails drafted + 1 club overflow; blogosphere thinner than expected — lots of IG-only)*
- **Terrier Owner** — terrierowner.com — owner blog (Josh Martin; JRT "Luna" is the flagship voice) — ✉️ **terrierowner@gmail.com** (on-page "[at]" style, de-obfuscated — poms@poms.cc precedent) — High (© 2026, fresh posts rail) — *hook: "7 Questions to Ask Yourself Before Adopting a Jack Russell Terrier"; Luna adopted ~2020* — **DRAFTED** — note: affiliate-monetized but genuinely owner-written
- **Jack Russell Advice** — jackrusselladvice.co.uk — owner-run advice site (Jon, UK; JRT "Poppy") — ✉️ **jon@jackrusselladvice.co.uk** ("You can reach me at…" literal on contact page) — Med-High (© 2014–2026, "New!" articles) — *hook: his dog age calculator + free JRT Toolkit ebook w/ 3,000+ subscribers* — **DRAFTED**
- **JRTCA** — therealjackrussell.com — world's largest JRT club/registry (est. 1976; ~1,200-dog National Trial) — ✉️ **JRTCA@theRealJackRussell.com** ("The email address of the JRTCA club office is…" literal) — High — ⚠️ pointedly anti-kennel-club/anti-conformation ("narrow, cosmetic breed standards") — our no-judges/audience-votes framing actually aligns, but the phrase "dog show" is tone-sensitive — **NOT DRAFTED this run (cap + framing needs care)** — verified email ready; lead with "no judges, every dog wins," never "conformation"
- **The Jack Russell Terrier Blog** — thejackrussell.co.uk — owner blog (Jo Williams, UK; certified positive-reinforcement trainer, five JRTs: Milo, Pepper, Patch, Minty, Pablo the Butternut Box "Ambassadog") — 📝 form only — High (post 04/02/2026) — MANUAL (best JRT form prospect)
- **Jack Russell World** — jackrussellworld.co.uk — owner blog (Amy Trumpeter, UK; "a JRT a decade", current dog Blake, RSPCA rescue) — no email on fetched pages; explicitly invites reader story submissions — Med — MANUAL — ⚠️ main blog page carries deep grief passages (Patch, Milo) — gentle tone, never reference the deceased dogs. *(Rejected: Jack Russell Parents — dormant Mar 2022; snowcreekjackrussell.com — unfetchable, unverified.)*

## Wave 12 draft messages (15 staged 2026-07-15)

All follow the standard template with these per-prospect personalizations (full text lives in the Gmail drafts):
1. **Molly Paws Up** (fetch@mollypawsup.com, "Hi Tomasz") — "Why You Shouldn't Get a Springer Spaniel" as the most honest breed writing of the year.
2. **Gulf Coast ESS** (Farmerclary@gmail.com, "Hi Carol") — Zofie & Pat Gleich therapy-team congrats; softened (no blog); FB trouble not referenced.
3. **Berry's Wonder Hounds** (bwhounds@outlook.com) — "Greyhounds and Little Humans" + gorgeous snooty Niko; sincere tone, no irony.
4. **Greyhound Friends for Life** (greyhoundfriendsforlife@gmail.com) — reunion-photos post; adopter angle + offer to point readers to adoption; racing-neutral.
5. **Bright Star** (brightstarsetters@gmail.com, "Hi Tracy") — River's Championship at Woofstock + Declan's Grand at 2; "no judges, just applause" complementary framing.
6. **Erinshire** (brenda@erinshireirishsetters.com, "Hi Brenda") — Paige's three-years-waited litter; ~50 years in the breed; winding-down not referenced.
7. **Dearg na hEireann** (Dearg.Na.Heireann@gmail.com, "Hi Lesley") — O'Malley Malone's film/model/therapy résumé; softened.
8. **Westover** (westoverwolfhounds@gmail.com, "Hi Stephanie and Val") — Hunter Creek Trail write-up; wolfhounds + horses + pack goats caravan.
9. **Ballyhara** (lisa@lisadubeforman.com, "Hi Lisa") — "hands people the invoice first" honesty of her expense/acreage pages.
10. **Bonaforte** (wolfhounds@bonaforte.com, "Hi Carla") — "I am a dog breeder" essay; fresh-outing framing for the dormant blog.
11. **IGRC UK** (info@italiangreyhoundrescuecharity.org.uk) — Iggy Tea Party in Coventry (Amy & Carole); rescue angle + adoption pointer.
12. **Italian Greyhound Place** (ig@italiangreyhoundplace.com) — opens "this isn't a rehoming enquiry"; Westminster 2026 IG judging note.
13. **Levriero Italiano** (info@levrieroitaliano.blog) — the treat-bag-from-3-km joke; written in deliberately simple English.
14. **Terrier Owner** (terrierowner@gmail.com, "Hi Josh") — the "7 Questions" adoption gut-check; scratch for Luna.
